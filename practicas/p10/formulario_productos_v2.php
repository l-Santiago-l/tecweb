                ...
                <form id="formProductos" action="set_producto_v2.php" method="post">    
                    <fieldset>
                        ...
                        <fieldset>
                            ...
                            <input type="text" value="<?= !empty($_POST['nombre'])?$_POST['nombre']:$_GET['nombre'] ?>" name="nombre" id="inNom" class="formI" oninput="validarTam(event, this, 'lblNombre');" onkeypress="vacio(this, 'lblNombre', 100);" onblur="validarObligatoriosL(this, 'lblNombreA');"><br/>
                        ...
                        <fieldset>
                            ...
                            <select name="marca" class="formI" size="1" id="inMarca" value="<?= !empty($_POST['marca'])?$_POST['marca']:$_GET['marca'] ?>">
                        ...
                        <fieldset>
                            ...
                            <input type="text" value="<?= !empty($_POST['modelo'])?$_POST['modelo']:$_GET['modelo'] ?>" name="modelo" id="inModelo" class="formI" oninput="validarTam(event, this, 'lblModelo');" onkeypress="vacio(this, 'lblModelo', 25);" onblur="validarObligatoriosL(this, 'lblModeloA');">
                        ...
                        <fieldset>
                            ...
                            <input type="number" value="<?= !empty($_POST['unidades'])?$_POST['unidades']:$_GET['unidades'] ?>" name="unidades" id="inUni" class="formI" onblur="validarObligatoriosN(this, 'lblUnidadesA', 0);" onkeypress="return valNumNa(event)">
                        ...
                        <fieldset>
                            ...
                            <textarea name="detalles" text="<?= !empty($_POST['detalles'])?$_POST['detalles']:$_GET['detalles'] ?>" id="inDet" rows="4" cols="60" class="formI" placeholder="No más de 250 caracteres de longitud" oninput="validarTam(event, this, 'lblDatelles');" onkeypress="vacio(this, 'lblDatelles', 250);" onblur="validarObligatorios(this, 'lblDatellesA');"></textarea>
